...
<html>
    ...
    <head>
        <title>RX Adobe CB-RAT 2024</title>
        <script>
    ...
    <body>
        ...
        <div class="container">
            <div class="right">
                <div class="header">
                    <h1>RX ADOBE-Regional Achievement Test</h1>
                    <div class="logo">
    ...
    echo '<select name="schoolid" class="form-control">';
...
if ($selected_grade) {
    ...
    $sql = "SELECT subject,file FROM subjects WHERE gradelevel = ?";
...
<select id="subject" name="subject" required>
    ...
    window.location.href = window.location.pathname + "?grade=" + grade;
                    ...
                    <button type="submit" onclick="alert('Your answer has been recorded');">Submit</button>
                </form>
